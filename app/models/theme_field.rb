...
class ThemeField < ActiveRecord::Base
  ...
  def process_html(html)
    ...
    doc.add_child("<script defer src='#{javascript_cache.url}'></script>") if javascript_cache.content.present?
  ...
  def process_translation
    ...
    javascript_cache.save!
    doc = ""
    doc = "<script defer src='#{javascript_cache.url}'></script>" if javascript_cache.content.present?
    [doc, errors&.join("\n")]
  end
