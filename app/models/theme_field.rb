...
class ThemeField < ActiveRecord::Base
  ...
  def process_html(html)
    ...
    doc.add_child("<script#{defer_attribute} src='#{javascript_cache.url}'></script>") if javascript_cache.content.present?
  ...
  def process_translation
    ...
    doc = ""
    defer_attribute = SiteSetting.enable_experimental_javascript_defer ? ' defer' : ''
    doc = "<script#{defer_attribute} src='#{javascript_cache.url}'></script>" if javascript_cache.content.present?
    [doc, errors&.join("\n")]
  end
